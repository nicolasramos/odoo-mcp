...
2. Crea un nuevo token con el nombre "odoo-mcp"
...
- odoo_mcp-2.0.0-py3-none-any.whl
- odoo_mcp-2.0.0.tar.gz
...
Significa que ya existe una versión 2.0.0. Tendrás que cambiar la versión a 2.0.1 o superior.
